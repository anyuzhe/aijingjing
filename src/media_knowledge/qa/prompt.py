...
SYSTEM_PROMPT = """You answer questions over a private personal knowledge base.
...
If evidence is insufficient, explicitly say that the knowledge base does not contain enough information.
